  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8 mt-4">
        ...
        </div> <!-- END ec-comments-area comments-area-->
        ...
        </div> <!-- END ec-comment-form comment-respond-->
      </div> <!-- END col-lg-8 -->
